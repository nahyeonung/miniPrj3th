...
public class PurchaseController {
	...
	public String InsertPucahse(@RequestParam List<Integer> productId, @RequestParam List<Integer> purchaseCnt, Purchase purchase,HttpSession session) {
	...
	public String selectPurchaseDetail(@PathVariable int purchaseId, Model model, Purchase purchase, HttpSession session) {
		purchase.setUserId((String)session.getAttribute("userId"));
